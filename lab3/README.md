# Лабораторная работа по параллельному программированию №3
...
![результаты MPI](lab3.jpg)

## Выводы
Увеличение параметров распараллеливания наиболее эффективно для матриц большего размера
Рост производительности наблюдается до в диапазоне 1-8 процессов, что скорее всего является ограничением системы
Для небольших матриц потеря эффекта от доп. процессах наступает еще раньше, что может быть обусловлено большей ролью оверхеда по сравнению с малым объемом вычислений
